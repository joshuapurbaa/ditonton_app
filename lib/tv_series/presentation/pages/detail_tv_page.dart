...
//     return Consumer<TvDetailNotifier>(
//       builder: (context, data, child) {
//         if (data.tvSeasonEpisodeState == RequestState.Loading) {
//           return Center(
...
//             ),
//           );
//         } else if (data.tvSeasonEpisodeState == RequestState.Error) {
//           return Text(data.message, key: Key('error_tv_season_content'));
//         } else if (data.tvSeasonEpisodeState == RequestState.Loaded) {
//           final tvSeasonEps = data.tvSeasonEpisode[selectedIndex - 1];
//           final items = setTotalDropdownMenuItem(data.tvSeasonEpisode.length);
//           return Column(
//             crossAxisAlignment: CrossAxisAlignment.start,
//             children: [
//               Card(
...
//                   shrinkWrap: true,
//                   itemBuilder: (context, index) {
//                     final tvEpisode = tvSeasonEps.episodes[index];
//                     return TvEpisodeCard(
//                       episode: tvEpisode,
//                       index: index,
//                     );
//                   },
//                   itemCount: tvSeasonEps.episodes.length,
//                 ),
//               ),
//             ],
//           );
